...
DIGIT_OR_LETTER {UPCASE_LETTERS}|{DOWNCASE_LETTERS}|{DIGIT}

TYPEID {UPCASE_LETTERS}+({DIGIT}|{UPCASE_LETTERS}|{DOWNCASE_LETTERS}|_)*
OBJECTID {DIGIT_OR_LETTER}+({DIGIT_OR_LETTER}|_)*
DARROW =>
